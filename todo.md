...
- [ ] **TS不満調査からの追加討議項目(2026-07-21)** — 詳細は [docs/design-agenda.md](docs/design-agenda.md) H節
  - [ ] **H-1: `any`型の扱い** — critique-2026-07.mdが指摘した「抜け穴の無さ」の毀損が未決着のまま放置されていた。
        撤去 or JS相互運用境界専用への限定、どちらかを討議する
