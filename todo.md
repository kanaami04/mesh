...
- [ ] **批評ターン(2026-07-19)起点の再討議・実装** — 全記録は [docs/critique-2026-07.md](docs/critique-2026-07.md)、
  ...
  - 推奨順: ~~F-1(前半・後半)~~・~~F-2(前半・後半)~~・~~F-3~~・~~F-4~~・~~F-5~~・~~F-6~~(すべて✅ 2026-07-19)・
    ~~F-12第1ラウンド~~(✅ 2026-07-20。結果は [docs/benchmark-2026-07.md](docs/benchmark-2026-07.md))
  - **ベンチ第1ラウンドで出た改善項目(小さい・即日可能)**:
    - [ ] 複数行unionの行頭`|`継続をパーサ対応(TSフォーマットの負転移でMeshが唯一落ちた箇所)、
          またはカードに「unionは1行」と明記
    - [ ] 予約語一覧(`eval`/`arguments`等のRESERVED)をカードに明記
  - 応急処置(討議不要・即日可能): カード完全性の逆方向検査(`s[0]`未記載問題、F-13の一部)
