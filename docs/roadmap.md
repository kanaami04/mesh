...
- コメントは実装済み(2026-08-15: L-4の `//`・CRLF停止・EOF・L-30の `///`、L-5の `/*`→E0102)。文字列リテラル+補間(L-14〜L-18・L-28。**文字列スキャンのCR/CRLFはL-16のE0108優先**=ADR-0041。**補間内の `//` はコメントにせずE0115**=L-17(b))、行継続(L-19〜L-25)
